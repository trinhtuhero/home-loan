      ...
      <div class="content" style="background-color:#ffffff;color:#090909">
        ...
        <div class="message" style="padding:30px;text-align:justify;line-height:25px">
          <p style="Margin-Top:0;font-size:20px">
              <#if loanApplication.fullName??>${loanApplication.fullName?html}</#if> thân mến,
          </p>
          <p>Cám ơn Quý khách hàng đã quan tâm và đăng ký đề nghị vay vốn tại Ngân hàng MSB. Quý
            Khách hàng vui lòng kiểm tra thông tin và xác nhận Đơn đề nghị vay vốn,
            với mã <#if loanApplication.loanCode??>${loanApplication.loanCode}</#if>
            trước <#if confirmBeforeDate??>${confirmBeforeDate}</#if> để Hồ sơ tiếp tục được xử
            lý.</p>
          ...
          <p>
            Nếu Quý khách hàng gặp khó khăn khi thao tác, vui lòng liên hệ với MSB để được hỗ trợ
            trực tiếp trong thời gian sớm nhất.
          </p>
          <p>
