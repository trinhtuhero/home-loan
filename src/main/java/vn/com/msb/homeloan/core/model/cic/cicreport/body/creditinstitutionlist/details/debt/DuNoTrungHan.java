...
public class DuNoTrungHan {
    ...
    private Long sumDuNoTrungVND;

    private Long sumDuNoTrungUSD;

    public Long getSumDuNoTrungVND() {
        return sumDuNoTrungVND;
    }

    public void setSumDuNoTrungVND(Long sumDuNoTrungVND) {
        this.sumDuNoTrungVND = sumDuNoTrungVND;
    }

    public Long getSumDuNoTrungUSD() {
        return sumDuNoTrungUSD;
    }

    public void setSumDuNoTrungUSD(Long sumDuNoTrungUSD) {
        this.sumDuNoTrungUSD = sumDuNoTrungUSD;
    }
