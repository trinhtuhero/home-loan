    ...
    <div class="container" style="padding:20px;Margin:0 auto">
      ...
      <div class="content" style="background-color:#ffffff;color:#090909">
        ...
        <div class="message" style="padding:30px;text-align:justify;line-height:25px">
          ...
          <p>Đề nghị vay vốn <#if loanApplication.loanCode??>${loanApplication.loanCode}</#if> của
            Quý khách đã được MSB tiếp nhận và kiểm tra. Để hoàn tất việc đăng ký vay vốn tại MSB,
            Quý Khách hàng vui lòng bổ sung/điều chỉnh thông tin và hồ sơ theo hướng dẫn đã được gửi
            kèm hồ sơ.</p>
