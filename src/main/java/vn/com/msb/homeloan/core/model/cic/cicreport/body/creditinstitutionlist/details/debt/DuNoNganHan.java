...
public class DuNoNganHan {
    ...
    private Long sumDuNoNganVND;

    private Long sumDuNoNganUSD;

    public Long getSumDuNoNganVND() {
        return sumDuNoNganVND;
    }

    public void setSumDuNoNganVND(Long sumDuNoNganVND) {
        this.sumDuNoNganVND = sumDuNoNganVND;
    }

    public Long getSumDuNoNganUSD() {
        return sumDuNoNganUSD;
    }

    public void setSumDuNoNganUSD(Long sumDuNoNganUSD) {
        this.sumDuNoNganUSD = sumDuNoNganUSD;
    }
