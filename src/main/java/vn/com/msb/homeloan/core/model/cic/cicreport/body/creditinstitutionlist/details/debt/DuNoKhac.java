...
public class DuNoKhac {
    ...
    private Long sumDuNoKhacVND;

    private Long sumDuNoKhacUSD;

    public Long getSumDuNoKhacVND() {
        return sumDuNoKhacVND;
    }

    public void setSumDuNoKhacVND(Long sumDuNoKhacVND) {
        this.sumDuNoKhacVND = sumDuNoKhacVND;
    }

    public Long getSumDuNoKhacUSD() {
        return sumDuNoKhacUSD;
    }

    public void setSumDuNoKhacUSD(Long sumDuNoKhacUSD) {
        this.sumDuNoKhacUSD = sumDuNoKhacUSD;
    }
