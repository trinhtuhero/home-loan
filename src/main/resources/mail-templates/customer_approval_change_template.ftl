      ...
      <div class="content" style="background-color:#ffffff;color:#090909">
        ...
        <div class="message" style="padding:30px;text-align:justify;line-height:25px">
          ...
          <p>Đề nghị vay vốn <#if loanApplication.loanCode??>${loanApplication.loanCode}</#if> của
            Quý khách hàng đã được xác nhận thành công tại Ngân hàng MSB!
            lúc <#if successTime??>${successTime}</#if> và chuyển sang Thẩm định hồ sơ.</p>
          <p>Kết quả thẩm định sẽ được thông báo tới Quý Khách hàng trong tối
            đa <#if numberOfWorkingDays??>${numberOfWorkingDays}</#if> ngày làm việc</p>
